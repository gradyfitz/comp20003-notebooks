...
EXPECTED=("Hazards after setup:" "Hazard 1: Brake service required. \[Class A, extraDataType: 0\]" "Hazard 2: Unknown issue in fluid level. \[Class U, extraDataType: 0\]" "Hazard 1 after class B severity update:" "Hazard 1: Brake service required. \[Class B, extraDataType: 0\]" "Hazard 2 after description and D-class update:" "Hazard 2: Fluid leak in tank 4 \[Class D, extraDataType: 0\]")

runGroupTest "" "$EXPECTED" "pc_2_r_2.res"
